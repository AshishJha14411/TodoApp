...
const Login = () => {
  return (
    <div className='bg-[#03203C] w-2/5 flex flex-col rounded-[4%] justify-center'>
        <h1 className='text-[3rem] text-center font-bold text-white my-5'>Todo App Login</h1>
        <input 
        ...
        />
        <button className='w-2/5 mx-auto my-6 p-4 text-white fond-extrabold bg-[#207398] rounded-full text-xl hover:bg-[#51E1ED] hover:text-black ease-in duration-200'>Login</button>
